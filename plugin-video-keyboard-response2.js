var jsPsychVideoKeyboardResponse2 = (function (jspsych) {
  "use strict";
  ...
  class VideoKeyboardResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      video_html += ">";
      var video_preload_blob = this.jsPsych.pluginAPI.getVideoBuffer(
        trial.stimulus[0]
      );
      ...
      video_element.onended = () => {
        ...
        if (
          trial.response_allowed_while_playing == false &&
          !trial.trial_ends_after_video
        ) {
